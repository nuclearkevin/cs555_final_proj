...
The Jupyter notebook implementing the method (and describing it) can be found in `1D_sn_miniapp.ipynb`. My slides for the presentation given can be found in `/presentation/*`.
